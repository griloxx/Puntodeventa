            ...
            <form method="POST" class="formulario-datos" enctype="multipart/form-data">
                <fieldset class="int-formulario">
                    <div class="datos">
                        ...
                        <input type="text" name="empresa[nif]" placeholder="Introduce un NIF/CIF" id="nif" value="<?php echo s($empresa->nif); ?>" required>

                        <label for="nombre comercial">Nombre Comercial:</label>
                        <input type="text" name="empresa[nombreComercial]" placeholder="Nombre Comercial" id="nombreComercial" value="<?php echo s($empresa->nombreComercial); ?>" required>

                        <label for="nombre">Nombre:</label>
                        <input type="text" name="empresa[nombre]" placeholder="Nombre" id="nombre" value="<?php echo s($empresa->nombre); ?>" required>
                        ...
                        <input type="text" name="empresa[poblacion]" placeholder="Poblacion" id="poblacion" value="<?php echo s($empresa->poblacion); ?>" required>

                        <label for="cp">CP:</label>
                        <input type="text" name="empresa[cp]" placeholder="Codigo Postal" id="cp" value="<?php echo s($empresa->cp); ?>" required>
                        
                        <label for="email">Email:</label>
                        <input type="email" name="empresa[email]" placeholder="Email Tienda" id="email" value="<?php echo s($empresa->email); ?>" required>
                        
                        <label for="telefono">Telefono:</label>
                        <input type="telefono" name="empresa[telefono]" placeholder="Telefono Tienda" id="telefono" value="<?php echo s($empresa->telefono); ?>" required>
                    </div>
